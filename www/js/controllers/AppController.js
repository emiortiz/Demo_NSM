...
function AppController(
    ...
    $scope.$watch(function () {
        ...
        if(ionic.Platform.isAndroid()) {
            ...
            var icon = angular.element(document.querySelector('.menu-content .left-buttons button'));
    		var menu = angular.element(document.querySelector('.menu.menu-left'));
            var scrollContent = angular.element(document.querySelector('.menu-content .scroll-content'));
        }
